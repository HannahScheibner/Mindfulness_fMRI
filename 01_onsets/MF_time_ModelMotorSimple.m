...
function [names, onsets_thought, durations] = MF_time_ModelMotorSimple(prefix, name)
...
%         end
        ...
        onsets_Motor{1} = [onsets_Motor{1} (event_time(i))];
    end
...
cd(subj_dir);
cd('onsets');
save(strcat(prefix,name,'_time_ModelMotorSimple.mat'), 'names', 'onsets_Motor',  'durations_Motor');
if computer ==1
