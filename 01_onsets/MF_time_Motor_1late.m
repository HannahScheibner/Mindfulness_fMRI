...
function [names, onsets_thought, durations] = MF_time_Model_1late(prefix, name)
...
cd(subj_dir);
cd('onsets');
save(strcat(prefix,name,'_time_Motor_1late.mat'), 'names', 'onsets_Motor',  'durations_Motor');
if computer ==1
