...
function [names, onsets_thought, durations] = MF_time_Model_1early(prefix, name)
...
%         end
        ...
        onsets_Motor{1} = [onsets_Motor{1} (event_time(i)-1)];
    end
...
cd(subj_dir);
cd('onsets');
save(strcat(prefix,name,'_time_Motor_1early.mat'), 'names', 'onsets_Motor',  'durations_Motor');
if computer ==1
