...
cd(subj_dir);
cd('onsets');
save(strcat(prefix,name,'_time_Model3.mat'), 'names', 'names_extras','onsets_thought', 'onsets_response', 'onsets_nointerest', 'durations_thought', 'durations_response', 'durations_nointerest');
if computer ==1
