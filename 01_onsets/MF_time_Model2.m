...
function [names, onsets_thought, durations] = MF_time_Model2(prefix, name)
                   ...
                   if strcmp (fcode{m}, '1') ==1
                    ...
                    elseif strcmp (fcode{m}, '2') ==1
                     ...
                     if response_time(i) - event_time(i)  >3
                        ...
                        onsets_nointerest{1} = [onsets_nointerest{1} (response_time(i)+6)];
                        n(i) = (response_time(i)+6);
                     else
                         ...
                         onsets_nointerest{1} = [onsets_nointerest{1} (event_time(i)+9)];
                         n(i) = (event_time(i)+9);
                     end;
                     if i >1
...
cd(subj_dir);
cd('onsets');
save(strcat(prefix,name,'_time_Model2.mat'), 'names', 'names_extras','onsets_thought', 'onsets_response', 'onsets_shift', 'onsets_focus', 'onsets_nointerest', 'durations_thought', 'durations_response', 'durations_shift', 'durations_focus', 'durations_nointerest');
if computer ==1
