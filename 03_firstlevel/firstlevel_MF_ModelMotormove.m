function firstlevel_MF_ModelMotormovesimple(ids)
...
computer = 3; % 1 = ubuntu, 2 = mac, 3 = windows
    ...
    elseif computer == 3 %windows
       analysis_name     = 'ModelMotorMoveSimple';
...
onset1_1 = '-01_fMRT_mindfulness_internal_15_sce.log_time_ModelMotorSimple.mat';
onset1_2 = '-01_fMRT_mindfulness_external_15_sce.log_time_ModelMotorSimple.mat';
onset2_1 = '-02_fMRT_mindfulness_external_15_sce.log_time_ModelMotorSimple.mat';
onset2_2 = '-02_fMRT_mindfulness_internal_15_sce.log_time_ModelMotorSimple.mat';
onset3_1 = '-03_fMRT_mindfulness_internal_7.log_time_ModelMotorSimple.mat';
onset3_2 = '-03_fMRT_mindfulness_external_7.log_time_ModelMotorSimple.mat';
onset4_1 = '-04_fMRT_mindfulness_external_7.log_time_ModelMotorSimple.mat';
onset4_2 = '-04_fMRT_mindfulness_internal_7.log_time_ModelMotorSimple.mat';
...
%                  matlabbatch{z}.spm.stats.fmri_spec.sess(s).scans             = select_scans('^s8.*',[base filesep num2str(subs(g)) filesep task filesep num2str(s)]) %kann je nach smoothing ge�ndert werden
            ...
            matlabbatch{z}.spm.stats.fmri_spec.sess(s).cond(1).onset     = sess_onsets.onsets_Motor{1,1};
            matlabbatch{z}.spm.stats.fmri_spec.sess(s).cond(1).duration  = sess_onsets.durations_Motor{1,1};
...
%             matlabbatch{z}.spm.stats.fmri_spec.sess(s).cond(2).onset     = sess_onsets.onsets_Motor{2,1};
%             matlabbatch{z}.spm.stats.fmri_spec.sess(s).cond(2).duration  = sess_onsets.durations_Motor{2,1};
...
%             matlabbatch{z}.spm.stats.con.consess{1}.fcon.convec  = {[eye(32) zeros(32,1)]}; %% 12 = es gibt 8 Moglichkeiten fuer 4 sessions
%             
%             
%             matlabbatch{z}.spm.stats.con.consess{2}.tcon.name    = 'Links';
%             matlabbatch{z}.spm.stats.con.consess{2}.tcon.convec  = [1 0 zeros(1,6) 1 0 zeros(1,6) 1 0 zeros(1,6) 1 0 zeros(1,6)];
%             
%             matlabbatch{z}.spm.stats.con.consess{3}.tcon.name    = 'Rechts';
%             matlabbatch{z}.spm.stats.con.consess{3}.tcon.convec  = [0 1 zeros(1,6) 0 1 zeros(1,6) 0 1 zeros(1,6) 0 1 zeros(1,6)];  
% 
%         end
%     
