function firstlevel_MF_response
...
subs      = [201, 204, 208, 209, 211, 214:215,220:222];
%100, 103, 105,  110, 112:116, 119, 
...
onset1_1 = '-01_fMRT_mindfulness_internal_15_sce.log_time_response.mat';
onset1_2 = '-01_fMRT_mindfulness_external_15_sce.log_time_response.mat';
onset2_1 = '-02_fMRT_mindfulness_external_15_sce.log_time_response.mat';
onset2_2 = '-02_fMRT_mindfulness_internal_15_sce.log_time_response.mat';
onset3_1 = '-03_fMRT_mindfulness_internal_7.log_time_response.mat';
onset3_2 = '-03_fMRT_mindfulness_external_7.log_time_response.mat';
onset4_1 = '-04_fMRT_mindfulness_external_7.log_time_response.mat';
onset4_2 = '-04_fMRT_mindfulness_internal_7.log_time_response.mat';
...
%             matlabbatch{z}.spm.stats.fmri_spec.sess(s).cond(3).tmod      = 0
    ...
    % ---------
        if inference
            ...
            matlabbatch{z}.spm.stats.con.consess{1}.fcon.convec  = {[eye(4) zeros(4,1)]}; %% 12= es gibt 2 Moglichkeiten fuer 4 sessions
