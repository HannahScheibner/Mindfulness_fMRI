function firstlevel_MF_Model_10Secs(ids)
...
computer = 3; % 1 = ubuntu, 2 = mac, 3 = windows
    ...
    elseif computer == 3 %windows
       analysis_name     = '\first_level\Model10Sec';
...
%             matlabbatch{1}.spm.stats.fmri_spec.sess.multi_reg = {'F:\MF_MRTStudie\01_Daten\Probanden\100\NIFTI\MF_Task_0005\rp_fMF_w_HC_100-152603-00006-00006-1.txt'};
    ...
    % ---------
        if inference
            ...
            matlabbatch{z}.spm.stats.con.consess{1}.fcon.convec  = {[eye(32) zeros(32,1)]}; %% 32 = es gibt 8 Moglichkeiten fuer 4 sessions
...
%             matlabbatch{z}.spm.stats.con.consess{4}.tcon.convec  = [1 -1 1 -1 1 -1 1 -1]; 
            ...
            matlabbatch{z}.spm.stats.con.consess{2}.tcon.name    = 'MF_Ton';
            matlabbatch{z}.spm.stats.con.consess{2}.tcon.convec  = [1 zeros(1,15) 1 zeros(1,15)];
    
            matlabbatch{z}.spm.stats.con.consess{3}.tcon.name    = 'MW_Ton';
            matlabbatch{z}.spm.stats.con.consess{3}.tcon.convec  = [0 1 zeros(1,15) 1 zeros(1,14)];
            
            matlabbatch{z}.spm.stats.con.consess{4}.tcon.name    = 'MF_Atem';
            matlabbatch{z}.spm.stats.con.consess{4}.tcon.convec  = [zeros(1,8) 1 0 zeros(1,14) 1 0 zeros(1,6)];

            matlabbatch{z}.spm.stats.con.consess{5}.tcon.name    = 'MW_Atem';
            matlabbatch{z}.spm.stats.con.consess{5}.tcon.convec  = [zeros(1,8) 0 1 zeros(1,14) 0 1 zeros(1,6)];
            ...
            matlabbatch{z}.spm.stats.con.consess{2}.tcon.name    = 'MF_Ton';
            matlabbatch{z}.spm.stats.con.consess{2}.tcon.convec  = [zeros(1,8) 1 0 zeros(1,14) 1 0 zeros(1,6)];
    
            matlabbatch{z}.spm.stats.con.consess{3}.tcon.name    = 'MW_Ton';
            matlabbatch{z}.spm.stats.con.consess{3}.tcon.convec  = [zeros(1,8) 0 1 zeros(1,14) 0 1 zeros(1,6)];
            
            matlabbatch{z}.spm.stats.con.consess{4}.tcon.name    = 'MF_Atem';
            matlabbatch{z}.spm.stats.con.consess{4}.tcon.convec  = [1 0 zeros(1,14) 1 0 zeros(1,14)];

            matlabbatch{z}.spm.stats.con.consess{5}.tcon.name    = 'MW_Atem';
            matlabbatch{z}.spm.stats.con.consess{5}.tcon.convec  = [0 1 zeros(1,14) 0 1 zeros(1,14)];
