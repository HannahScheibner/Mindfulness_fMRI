...
jobfile = {'C:\Users\scheibha\Documents\Mindfulness_fMRI\03_firstlevel\seconds_job.m'};
...
for crun = 1:nrun
    ...
    inputs{3, crun} = MATLAB_CODE_TO_FILL_INPUT; % fMRI model specification: Data & Design - cfg_repeat
end
spm('defaults', 'FMRI');
