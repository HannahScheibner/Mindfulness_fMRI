...
computer = 3; % 1 = ubuntu, 2 = mac, 3 = windows
    ...
    elseif computer ==3 %windows
        ...
        designdirectory = {'C:\Users\scheibha\Documents\MRT_HC\01_Daten\secondlevel_10'};
    end
...
for g = 1:size(subs,2)  
scans_1_1 {g,1} = strcat(filename, num2str(subs(g)), '/1stlevel_10/con_0005.nii,1'); %Atem achtsam
scans_1_2 {g,1} = strcat(filename, num2str(subs(g)), '/1stlevel_10/con_0004.nii,1'); %Ton achtsam
scans_2_1 {g,1} = strcat(filename, num2str(subs(g)), '/1stlevel_10/con_0003.nii,1'); %Atem abgelenkt
scans_2_2 {g,1} = strcat(filename, num2str(subs(g)), '/1stlevel_10/con_0002.nii,1'); %Ton abgelenkt
